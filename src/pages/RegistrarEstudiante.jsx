       ...
       >
          ...
          <Grid item xs={12} sm={6}>
            ...
            <Grid item xs={12} sm={6}>
                <FormControl>
                    ...
                    <Input id="apellido" type="TextField" aria-describedby="email-helper"></Input>
                </FormControl>
            ...
            <Grid item xs={12} sm={6}>
                <FormControl>
                    ...
                    <Input id="cedula" type="number" aria-describedby="email-helper"></Input>
                </FormControl>
        ...
        <Select >
          ...
          <MenuItem value={30}>Cedula Extranjeria</MenuItem>
            ...
            <Grid item xs={12} sm={6}>
                <FormControl>
                    <InputLabel htmlFor="expedicion">Lugar de expedicion</InputLabel>
                    <Input id="expedicion" type="TextField" aria-describedby="expedicion-helper"></Input>
                    <FormHelperText id="expedicion-helper">de la cedula</FormHelperText>
                </FormControl>
            ...
            <Grid item xs={12} sm={6}>
                <FormControl>
                    ...
                    <FormHelperText id="email-helper">email institucional</FormHelperText>
                </FormControl>
